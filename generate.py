...
for book in books_df.iterrows():
    ...
    isbn_hyphen_maps[1][book[1]["Electronic ISBN"]] = book[1][
        "Electronic ISBN"
    ].replace("-", "")
...
for group, books in grouped_books_df:
    ...
    for book in books.iterrows():
        book[1]["goodreads_review"] = isbn_review_map.get(
            isbn_hyphen_maps[0][book[1]["Print ISBN"]],
            isbn_review_map.get(isbn_hyphen_maps[1][book[1]["Electronic ISBN"]], None),
        )
